  ...
  return (
    <div>
      ...
      <main className="container mt-4">
        <h1 className="text-center color-official4 border-section-title banner-section-bg">Latest articles</h1>
        <div className="row">
            ...
            <div key={article.id} className="col-md-4 mb-4">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  {/* Utiliser six conditions pour afficher différents liens en fonction de l'ID */}
                  {article.id === 1 ? (
                    <Link
